...
width=1768; %Width of the picture you are working with
height=826; %Heigth of the picture you are working with
...
inputPicture = imread('blueyellowtraining.png');
%Image with the labels corresponding to your inputPicture
labelPicture = imread('blueyellowlabeled.png');
